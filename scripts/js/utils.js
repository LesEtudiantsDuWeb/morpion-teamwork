...
export const createArrayOfCases = (nbElements, defaultValue, nbColumns, colorPlayers) => Array.from(Array(nbElements), (_, i) => new Case(i, nbColumns, defaultValue, colorPlayers));
